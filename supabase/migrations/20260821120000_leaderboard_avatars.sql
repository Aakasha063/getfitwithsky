...
RETURNS TABLE(user_id uuid, display_name text, avatar_url text, avatar_color text, sessions integer, sets_count integer, total_volume numeric, last_session date, active_weeks integer)
LANGUAGE sql
